...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        try (Scanner input = new Scanner(System.in)) {
            ...
            String pathTest = "C:\\Users\\ACER\\OneDrive\\Desktop\\K-D Tree\\src\\test tree.txt";
            String pathTestLabel = "C:\\Users\\ACER\\OneDrive\\Desktop\\K-D Tree\\src\\testlbls (1).txt";
            ...
            float[][] testPoint = new float[200][k];

            // ReadFile read = new ReadFile();
            // point = read.Read(pathNode, pathLabel);

            ReadFile test = new ReadFile();
            testPoint = test.Read(pathTest, pathTestLabel);
            ...
            // float[] lbl = new float[200];
            // float[][] searchPoint7 = new float[200][k - 1];
            // for (int i = 0; i < 200; i++) {
            // for (int j = 0; j < 784; j++) {
            // searchPoint7[i][j] = testPoint[i][j];
            // }
            // }
            // for (int i = 0; i < 200; i++) {
            // for (int j = 0; j < 784; j++) {
            // System.out.print(searchPoint7[i][j]+" ");
            // }
            // System.out.print("\n");
